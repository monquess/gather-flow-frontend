...
const RegisterForm: React.FC = () => {
	...
	const handleSubmit = async (values: typeof form.values) => {
		if (!recaptcha.current?.getValue()) {
			showNotification('Register', t('register.captcha'), 'red')
		} else {
			try {
				setLoading(true)
				await axios.post(
				...
				form.reset()
				showNotification(t('register.title'), t('register.success'), 'green')
			} catch (error) {
	...
	return (
		<>
			...
			>
				...
				/>
				<Divider my="lg" label={t('register.or')} labelPosition="center" />
